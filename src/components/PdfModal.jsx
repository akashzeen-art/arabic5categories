  ...
  return (
    <AnimatePresence>
      {item && (
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between px-5 py-3 bg-[#0d1f3c] border-b border-[#c9a84c]/20 shrink-0">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#c9a84c] hover:text-[#0a1628] transition-colors flex items-center justify-center text-white shrink-0"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
